...
# QUIT, ACTIVEEVENT, KEYDOWN, KEYUP,
# MOUSENOTION, MOUSEBUTTONUP, MOUSEBUTTONDOWN,
# JOYAXISMOTION, JOYBALLMOTION, JOYHATMOTION,
# JOYBUTTONUP, JOYBUTTTONDOWN, VIDEORESIZE,
...
# snail_rect = snail_surf.get_rect(bottomright =(810,300))
...
game_name = test_font.render('A little Pygame runner!', False, (111,196,169))
game_name_rect = game_name.get_rect(center = (400,80))

game_message = test_font.render('Press Spacebar to start!', False, (111,196,169))
...
while True:
    ...
    if game_active:
        ...
        # if player_rect.bottom > ground_y_pos:player_rect.bottom = ground_y_pos
        # player_animation()
    ...
    # pygame.draw.line(screen, 'Green',(0,0),pygame.mouse.get_pos(), 50)
    # pygame.draw.ellipse(screen,'Brown', player_rect)# pygame.Rect(50,200,100,100))
